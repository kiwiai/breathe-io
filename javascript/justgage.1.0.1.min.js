 ...
 * -----------------------------
 ...
 JustGage = function(config) {
  ...
  obj.config =
  {
    ...
    titleFontColor : (config.titleFontColor) ? config.titleFontColor : "#dad9d9",
    ...
    valueFontColor : (config.valueFontColor) ? config.valueFontColor : "#dad9d9",
    ...
    labelFontColor : (config.labelFontColor) ? config.labelFontColor : "#dad9d9",
